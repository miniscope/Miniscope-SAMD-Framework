...
../MS_module/src
../MS_module/include
../MS_module/ASF_custom
```
7. Add Build events (configuration: All configurations)

Pre-build event command line
```ps
powershell.exe -ExecutionPolicy Bypass -NoProfile -NonInteractive -File "..\MS_module\script\MS_framework_end.ps1"
powershell.exe -ExecutionPolicy Bypass -NoProfile -NonInteractive -File "..\MS_module\script\MS_framework_init.ps1"
```
