...
6. Add following to the include path (Project -> Properties -> Toolchain -> ARM/GNU C Compiler -> Directories)
```
../Miniscope-SAMD-Framework/include
../Miniscope-SAMD-Framework/ASF_custom
```
